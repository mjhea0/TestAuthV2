class DonorsController < ApplicationController
  ...
  respond_to do |format|
    if @donor.save
      format.html {
        redirect_to [:admin, @donor],
          notice: 'Donor profile successfully created.'
      }
      format.json {
        render json: @donor,
          status: :created,
...
def donor_params
  params.require(:donor).permit(:description, :name, :permalink, :price, :file)
end
