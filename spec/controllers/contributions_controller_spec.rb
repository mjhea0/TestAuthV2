  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contribution as @contribution" do
        ...
        post :create, {:contribution => { "email" => "invalid value" }}, valid_session
        assigns(:contribution).should be_a_new(Contribution)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contribution" do
        ...
        Contribution.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => contribution.to_param, :contribution => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contribution as @contribution" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contribution.any_instance.stub(:save).and_return(false)
        put :update, {:id => contribution.to_param, :contribution => { "email" => "invalid value" }}, valid_session
        assigns(:contribution).should eq(contribution)
      end
